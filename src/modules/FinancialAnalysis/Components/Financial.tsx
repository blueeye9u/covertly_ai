                ...
                <div className='p-5 lg:p-10 bg-whiteSmoke dark:bg-[#FFFFFF05] rounded-2xl flex flex-col'>
                    ...
                    <ul className='mb-24'>
                        ...
                        <li className='fs-24 font-bold dark:text-white mb-8'>Need for Efficient and Secure AI Assistance
                            <div className='block text-base font-light mt-4 text-blackPearl dark:text-manatee'>{"AI-driven analysis improves financial insights, but it must be completely secure to be viable for enterprise use."}</div>
                        </li>
                    </ul>
                    <div className='pb-10 sm:pb-20'>
                        <div>
                            <h4 className='fs-32 mb-1'>How Covertly AI Solves These Challenges</h4>
                            ...
                            <div className='grid sm:grid-cols-2 gap-6'> 
                                <div className='p-5 lg:p-8 lg:px-6 rounded-xl bg-white dark:bg-[#FFFFFF08] flex flex-col shadow-sm' key={uuidv4()}>
                                    <Image src={isDarkMode ? "/assets/images/use-cases/2.svg" : "/assets/images/use-cases/2a.svg"} width={96} height={96} alt="how-covertly-solves-image" className='mb-4 text-black dark:text-white'/>
                                ...
                                <div className='p-5 lg:p-8 lg:px-6 rounded-xl bg-white dark:bg-[#FFFFFF08] flex flex-col shadow-sm' key={uuidv4()}>
                                    <Image src={isDarkMode ? "/assets/images/use-cases/3.svg" : "/assets/images/use-cases/3a.svg"} width={96} height={96} alt="how-covertly-solves-image" className='mb-4 text-black dark:text-white'/>
                                    <h5 className='fs-24 mb-3'>Auto-Deletion for Maximum Security</h5>
                                    <ul style={{listStyle: "disc", padding: "0 0 0 20px"}}>
                                        <li className="text-black dark:text-white text-sm">Once the analysis session ends, all input data is automatically deleted, ensuring compliance with financial regulations.</li>
                                ...
                                <div className='p-5 lg:p-8 lg:px-6 rounded-xl bg-white dark:bg-[#FFFFFF08] flex flex-col shadow-sm' key={uuidv4()}>
                                    <Image src={isDarkMode ? "/assets/images/use-cases/4.svg" : "/assets/images/use-cases/4a.svg"} width={96} height={96} alt="how-covertly-solves-image" className='mb-4 text-black dark:text-white'/>
                                    <h5 className='fs-24 mb-3'>AI-Powered Financial Insights with Google Search Integration</h5>
                                    <ul style={{listStyle: "disc", padding: "0 0 0 20px"}}>
                                        <li className="text-black dark:text-white text-sm">Unlike traditional AI models that rely on limited datasets, Coverly AI integrates with Google Search to provide real-time, reliable financial information.</li>
                                ...
                                <div className='p-5 lg:p-8 lg:px-6 rounded-xl bg-white dark:bg-[#FFFFFF08] flex flex-col shadow-sm' key={uuidv4()}>
                                    <Image src={isDarkMode ? "/assets/images/use-cases/5.svg" : "/assets/images/use-cases/5a.svg"} width={96} height={96} alt="how-covertly-solves-image" className='mb-4 text-black dark:text-white'/>
                    ...
                    <h3 className='fs-32 mb-2'>How Covertly AI Could Be Implemented for Financial Executives:</h3>
                    <div className='grid sm:custom-grid1 gap-6 mb-24'>
                        <div>
                            {
                                data.map((item,i)=>(
                                    <div key={uuidv4()} className='flex lg:flex-row flex-col gap-4 md:gap-4 lg:gap-8 lg:items-center border border-[#FFFFFF05] rounded-[16px] mb-5'>
                    ...
                    <h3 className='fs-32 mb-2'>Tittle?</h3>
